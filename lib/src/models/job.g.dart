...
JobStats _$JobStatsFromJson(Map<String, dynamic> json) => $checkedCreate(
      'JobStats',
      json,
      ($checkedConvert) {
        final val = JobStats(
...
JobResult _$JobResultFromJson(Map<String, dynamic> json) => $checkedCreate(
      ...
      ($checkedConvert) {
        final val = JobResult(
          ...
          warnings:
              $checkedConvert('warnings', (v) => v as Map<String, dynamic>?),
        );
        return val;
      },
...
Job _$JobFromJson(Map<String, dynamic> json) => $checkedCreate(
      ...
      ($checkedConvert) {
        final val = Job(
          ...
          spawnedChildren:
              $checkedConvert('spawned_children', (v) => (v as num?)?.toInt()),
          stats: $checkedConvert(
              'stats', (v) => JobStats.fromJson(v as Map<String, dynamic>)),
...
Map<String, dynamic> _$JobToJson(Job instance) => <String, dynamic>{
      ...
      if (instance.spawnedChildren case final value?) 'spawned_children': value,
