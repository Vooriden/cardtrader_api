...
Product _$ProductFromJson(Map<String, dynamic> json) => $checkedCreate(
      ...
      ($checkedConvert) {
        final val = Product(
          ...
          bundleSize:
              $checkedConvert('bundle_size', (v) => (v as num?)?.toInt() ?? 1),
          bundledQuantity:
              $checkedConvert('bundled_quantity', (v) => (v as num?)?.toInt()),
...
Map<String, dynamic> _$ProductToJson(Product instance) => <String, dynamic>{
      ...
      if (instance.expansionId case final value?) 'expansion_id': value,
      ...
      if (instance.bundledQuantity case final value?) 'bundled_quantity': value,
