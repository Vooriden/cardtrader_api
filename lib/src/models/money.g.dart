...
Money _$MoneyFromJson(Map<String, dynamic> json) => $checkedCreate(
      'Money',
      json,
      ($checkedConvert) {
        final val = Money(
          ...
          currencySymbol:
              $checkedConvert('currency_symbol', (v) => v as String?),
...
Map<String, dynamic> _$MoneyToJson(Money instance) => <String, dynamic>{
      ...
      if (instance.formatted case final value?) 'formatted': value,
    };
