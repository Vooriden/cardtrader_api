...
Ct0BoxItem _$Ct0BoxItemFromJson(Map<String, dynamic> json) => $checkedCreate(
  ...
  ($checkedConvert) {
    final val = Ct0BoxItem(
      ...
      paidAt: $checkedConvert('paid_at', (v) => DateTime.parse(v as String)),
      estimatedArrivedAt: $checkedConvert(
      ...
      returnToSeller: $checkedConvert('return_to_seller', (v) => v as bool?),
    );
    return val;
  },
  fieldKeyMap: const {
...
Map<String, dynamic> _$Ct0BoxItemToJson(Ct0BoxItem instance) =>
    <String, dynamic>{
      ...
      'estimated_arrived_at': ?instance.estimatedArrivedAt?.toIso8601String(),
      'arrived_at': ?instance.arrivedAt?.toIso8601String(),
      'cancelled_at': ?instance.cancelledAt?.toIso8601String(),
      'return_to_seller': ?instance.returnToSeller,
    };
